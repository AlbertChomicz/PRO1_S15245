...
ALTER TABLE ACH_ORDER_COMPOSITION DROP CONSTRAINT ACH_ORDER_COMPOSITION_ACH_ADDITIVE;

ALTER TABLE ACH_ORDER_COMPOSITION DROP CONSTRAINT ACH_ORDER_COMPOSITION_ACH_ORDER;

ALTER TABLE ACH_ORDER_COMPOSITION DROP CONSTRAINT ACH_ORDER_COMPOSITION_ACH_PIZZA;
...
DROP TABLE ACH_ORDER_COMPOSITION;
